...
NINHO_FORA_MAX_LINHA EQU 23
NINHO_DENTRO_MIN_COLUNA EQU 24
NINHO_DENTRO_MAX_COLUNA EQU 35
NINHO_FORA_MIN_COLUNA EQU 20
NINHO_FORA_MAX_COLUNA EQU 39
NINHO_MEIO_ESQUERDA EQU 27
NINHO_MEIO_DIREITA EQU 32
...
RESET_POSICAO:
	...
	PUSH R2
	MOV R1, DEF_CORDS_PACMAN_SPAWN
	MOV R2, POSICAO_INICIAL_PACMAN_X
	MOVB [R1], R2
	ADD R1, 1
	MOV R2, POSICAO_INICIAL_PACMAN_Y
	MOVB [R1], R2
	ADD R1, 1
	MOV R2, 0H
	MOVB [R1], R2
...
VERIFICA_LIMITES:
	...
	MOV R6, NINHO_MEIO_ESQUERDA
	MOV R7, NINHO_MEIO_DIREITA
	CMP R3, R6
	JZ POR_CIMA_OU_BAIXO
	CMP R3, R6
	JN DENTRO_NINHO
	CMP R3, R7
	JZ POR_CIMA_OU_BAIXO
	...
	JMP POR_CIMA_OU_BAIXO
	
POR_CIMA_OU_BAIXO:
	MOV R6, POSICAO_INICIAL_PACMAN_X
	CMP R2, R6
	JNN SAIR_NINHO_POR_BAIXO
	CMP R2, R6
	JN SAIR_NINHO_POR_CIMA
	
	
DENTRO_NINHO:
	MOV R6, NINHO_DENTRO_MIN_COLUNA
	MOV R7, NINHO_DENTRO_MAX_COLUNA
	CMP R3, R6
	JZ MOVIMENTO_INVALIDO
	CMP R3, R7
	JZ MOVIMENTO_INVALIDO
	
	MOV R6, NINHO_DENTRO_MIN_LINHA
	MOV R7, NINHO_DENTRO_MAX_LINHA
	CMP R2, R6
	JZ MOVIMENTO_INVALIDO
	CMP R2, R7
	JZ MOVIMENTO_INVALIDO
...
SAIR_NINHO_POR_CIMA:
	MOV R6, NINHO_DENTRO_MIN_LINHA
	MOV R7, NINHO_FORA_MIN_LINHA
	CMP R2, R7
	JN SAIU_DO_NINHO
	CMP R2, R6
	JZ PROCESSO_SAIR_DO_NINHO
	CMP R2, R6
	JNN DENTRO_NINHO
	JMP PROCESSO_SAIR_DO_NINHO
	
SAIR_NINHO_POR_BAIXO:
	MOV R6, NINHO_DENTRO_MAX_LINHA
